...
## if no enrichment handle empty results
  ...
  ## Return result list
  return(list(hallmark=p1, reactome=p8,immuno=p2, onco=p3, curated=p4, cancer.modules=p5,GO.BP=p6,cnetplot=q2, kegg.plot=q3,tf.targets=p7,table1=d1,table2=d2,table3=d3,table4=d4,table5=d5,table6=d6,table7=d7,table8=d8))
